...
from conf.settings_local import settings

tuling_mongo = NGMongoConnect(settings['tuling_mongodb']['host'], replica_set=settings["tuling_mongodb"].get("replica_set", None))
tuling_mongo_db = tuling_mongo.get_database('ios_mediacenter')
